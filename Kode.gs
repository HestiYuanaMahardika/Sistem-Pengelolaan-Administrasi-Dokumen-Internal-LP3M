...
function globalVariables(){ 
  var varArray = {
    spreadsheetId   : '11Lp6YkPI-fCqPaC25rgOHEIZRcOcmTFIVmDwRN-Rrmw', //** CHANGE !!!
...
/* ADD OR REMOVE VARIABLES ACCORDING TO YOUR FORM*/
  if(formObject.RecId && checkID(formObject.RecId)){
    var values = [[formObject.RecId.toString(),
                  formObject.nomorspr,
                  formObject.hasilpengukuran,
                  // formObject.status,
                  formObject.nama,
                  formObject.statuspenyelesaian,
                  formObject.jammulai,
                  formObject.jamselesai,
                  formObject.tanggal,
                  // formObject.ttdga,
                  formObject.penyelesaian,
                  formObject.penyebab,
                  formObject.statuspenyebab]];
